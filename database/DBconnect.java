...
public class DBconnect {
     ...
     */
    public static boolean insertTransaction(int userId, String type, double amount, String category, String transactionDate, String description) {
        // Basic validation
        if (amount <= 0) {
        ...
        try {
            String sql = "INSERT INTO TRANSACTIONS (UserID, Type, Amount, Category, TransactionDate, Description) " + "VALUES (?, ?, ?, ?, ?, ?)";
            PreparedStatement ps = con.prepareStatement(sql);
            ps.setInt(1, userId);
            ps.setString(2, type);
     ...
     */
    public static boolean updateTransaction(int transId, int requestingUserId, String type, double amount, String category, String transactionDate, String description) {
        if (amount <= 0) {
        ...
        try {
            ...
            String sql = "UPDATE TRANSACTIONS " + "SET Type=?, Amount=?, Category=?, TransactionDate=?, Description=? " + "WHERE TransID=? AND UserID=?";
            PreparedStatement ps = con.prepareStatement(sql);
            ps.setString(1, type);
    ...
    public static List<String[]> getTransactionsByUser(int userId) {
        ...
        try {
            ...
            String sql = "SELECT TransID, Type, Amount, Category, TransactionDate, Description " + "FROM TRANSACTIONS WHERE UserID = ? ORDER BY TransactionDate DESC";
            PreparedStatement ps = con.prepareStatement(sql);
            ps.setInt(1, userId);
            ResultSet rs = ps.executeQuery();
    ...
    public static List<String[]> adminGetAllTransactions(int requestingUserId) {
        ...
        // TODO: implement full admin fetch
        System.out.println("adminGetAllTransactions: not yet implemented.");
        return new ArrayList<>();
    }
    ...
    public static boolean adminDeleteTransaction(int requestingUserId, int transId) {
        ...
        System.out.println("adminDeleteTransaction: not yet implemented.");
        return false;
    }
    ...
    public static List<String[]> adminGetAllUsers(int requestingUserId) {
        ...
        System.out.println("adminGetAllUsers: not yet implemented.");
        return new ArrayList<>();
    }
}
